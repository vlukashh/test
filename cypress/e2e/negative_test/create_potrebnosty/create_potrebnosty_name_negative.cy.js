describe('Create potrebnosty test', () => {
    it('Create potrebnosty negative test', () => {
        cy.fixture('employer').then(data => {
            ...
            cy.get('.desktop-modal__content > .vacancy-need-wrapper > .form > :nth-child(1) > .form__labels > .labels > :nth-child(1) > .form-control--responsive > .form-input--text').type(data.wrong_name, {force: true});
