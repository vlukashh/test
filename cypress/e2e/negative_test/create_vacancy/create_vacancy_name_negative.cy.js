describe('Create vacancy test', () => {
    it('Создание вакансии с некорректным названием ', () => {
        cy.fixture('employer').then(data => {
            ...
            cy.get('.vacancy-add-form-wrapper > .form > :nth-child(1) > .form__labels > .labels > :nth-child(1) > .form-control--responsive > .form-input--').type(data.wrong_name, {force: true});
